    ...
    <div class="container text-end">
        ...
        <div class="row">
            <div class="col-12">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="row mb-1">
                                                    <div class="col-6" dir="rtl">{{ $item->product_price }} {{ __('admin.rs') }}
                                                    </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-6" dir="rtl">{{ $item->total_price }} {{ __('admin.rs') }}
                                                    </div>
                ...
                <!-- New Store Details Card -->
                <div class="card mt-4 mb-4">
                    <div class="card-header">
                        <h5 class="">{{ __('admin.store_details') }} <i class="fa fa-shop"></i></h5>
                    </div>
                    <hr>
                    <div class="card-content">
                        <div class="card-body">
                            <div class="mb-3 d-flex justify-content-center align-items-center">
                                <div id="imageContainer" class="image-upload-square border">
                                    <img id="previewImage" src="{{ $order->store->image }}" alt="Store Image"
                                        style="max-width: 100%; max-height: 100%; border-radius: 5px;" />
                                </div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-4">{{ $order->store->name }}</div>
                                <div class="col-8">{{ __('admin.store_name') }}</div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-4">{{ $order->store->rating }}</div>
                                <div class="col-8">{{ __('admin.store_rating') }}</div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-4">{{ $order->store->area }}</div>
                                <div class="col-8">{{ __('admin.store_area') }}</div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-4">{{ $order->store->category->name ?? 'N/A' }}</div>
                                <div class="col-8">{{ __('admin.store_category') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @if ($order->user)
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="mb-3 d-flex justify-content-center align-items-center">
                                    <div id="imageContainer" class="image-upload-square border">
                                        <img id="previewImage" src="{{ $order->user->image }}" alt="Image Preview"
                                            style="max-width: 100%; max-height: 100%; border-radius: 5px;" />
                                    </div>
                                </div>
                                <div class="row mb-1">
                    ...
                    @if ($order->delegate)
                        <div class="card-content">
                            <div class="card-body">
                                <div class="mb-3 d-flex justify-content-center align-items-center">
                                    <div id="imageContainer" class="image-upload-square border">
                                        <img id="previewImage" src="{{ $order->delegate->image }}" alt="Image Preview"
                                            style="max-width: 100%; max-height: 100%; border-radius: 5px;" />
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-4">{{ $order->delegate->first_name }} {{ $order->delegate->last_name }}
                                    </div>
